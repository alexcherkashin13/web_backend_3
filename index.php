...
try {
    $stmt = $db->prepare("INSERT INTO task_3 SET name = ?, email = ?, year = ?, sex = ?, limbs = ?, biography = ?");
    $stmt->execute([$_POST['fio'], $_POST['email'], intval($year) , $_POST['sex'], intval($limbs),  $_POST['field-name-2']]);
}
